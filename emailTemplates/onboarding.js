const json = `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
...
<body>
  ...
  <![endif]-->
                                                                    ...
                                                                    <tr>
                                                                        <td role="modules-container"
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td style="font-size:6px; line-height:10px; padding:30px 0px 30px 0px;"
                                                                                            ...
                                                                                            <h1
                                                                                                style="font-size:20px; color: black; margin-left:20px">
                                                                                                New News</h1>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            ...
                                                                            <table class="wrapper" role="module"
                                                                                ...
                                                                                width="100%"
                                                                                style="table-layout: fixed;"
                                                                                data-muid="3Ypdby9Xfsf2rN27zTDEfN">
                                                                                <tbody>
                                                                                    <tr>
                                                                            ...
                                                                            <table class="module" role="module"
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td style="background-color:#FE5D61; padding:50px 0px 30px 0px; line-height:22px; text-align:inherit;"
                                                                                            ...
                                                                                            <div>
                                                                                                <div
                                                                                                    ...
                                                                                                    <span
                                                                                                        style="font-size: 24px">Welcome!</span>
                                                                                                </div>
                                                                                                <div></div>
                                                                                            </div>
                                                                                        </td>
                                                                            ...
                                                                            <table class="module" role="module"
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td style="background-color:#fe5d61; padding:5px 50px 30px 50px; line-height:22px; text-align:inherit;"
                                                                                            height="100%" valign="top"
                                                                                            bgcolor="#fe5d61">
                                                                                            <div>
                                                                                                <div
                                                            ...
                                                            <div data-role="module-unsubscribe"
                                                                ...
                                                                style="color:#FFFFFF; font-size:12px; line-height:20px; padding:16px 16px 16px 16px; text-align:center;"
                                                                data-muid="txBUUpmixSjuZ5Ad69p1sX">
